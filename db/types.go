...
func (u *User) HasRoleFor(address internal.HexBytes, role UserRole) bool {
	for _, org := range u.Organizations {
		if org.Address.Equals(address) &&
...
type OrganizationUser struct {
	Address internal.HexBytes `json:"address" bson:"_id"`
...
type Organization struct {
	...
	Parent          internal.HexBytes        `json:"parent" bson:"parent"`
...
type OrganizationInvite struct {
	...
	OrganizationAddress internal.HexBytes  `json:"organizationAddress" bson:"organizationAddress"`
...
type Census struct {
	ID         primitive.ObjectID `json:"id" bson:"_id,omitempty"`
	OrgAddress internal.HexBytes  `json:"orgAddress" bson:"orgAddress"`
...
type Process struct {
	...
	OrgAddress      internal.HexBytes `json:"orgAdress" bson:"orgAddress"`
...
type ProcessesBundle struct {
	...
	OrgAddress internal.HexBytes   `json:"orgAddress" bson:"orgAddress"`                                                          // The organization that owns this bundle
