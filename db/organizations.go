...
// DeleteOrganizationMetaFields deletes specific keys from the 'meta' object of a given Organization
func (ms *MongoStorage) DeleteOrganizationMetaFields(address string, keysToDelete []string) error {
	unsetFields := bson.M{}
