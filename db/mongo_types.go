...
type OrgParticipantsGroupsCollection struct {
	OrgParticipantsGroups []OrgParticipantsGroup `json:"orgParticipantGroups" bson:"orgParticipantGroups"`
}
...
type Collection struct {
	...
	OrgParticipantsGroupsCollection
