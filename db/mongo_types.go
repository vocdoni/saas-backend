...
type OrgMembersGroupsCollection struct {
	OrgParticipantsGroups []OrganizationMemberGroup `json:"organizationMemberGroups" bson:"organizationMemberGroups"`
}
