...
func (ms *MongoStorage) validateCensusParticipant(participant *CensusParticipant) (internal.HexBytes, error) {
...
func prepareMember(member *OrgMember, orgAddress internal.HexBytes, salt string, currentTime time.Time) {
