...
//	@Description	Publish a census populated from a specific organization members group, applying the
//	@Description	auth/2FA/weighted settings in the body. The CSP public key becomes the census root.
//	@Description	Requires Manager/Admin role and is subject to the plan's census quota. Idempotent: an
//	@Description	already-published census is returned as-is. Returns the published census URI, root and
//	@Description	the number of members inserted.
//	@Description
//	@Description	Also callable with a scoped API key (scope: `voting:write`).
//	@Tags			census
//	@Accept			json
...
//	@Failure		401		{object}	errors.Error	"Unauthorized"
//	@Failure		403		{object}	errors.Error	"Plan census quota exceeded"
//	@Failure		404		{object}	errors.Error	"Census not found or unsupported (non-CSP) census type"
//	@Failure		500		{object}	errors.Error	"Internal server error"
