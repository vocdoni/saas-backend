...
func main() {
	...
	// 	Phone: "+1234567890",
	// }
	// leadID, err := crmClient.HandleLead(lead.Name, lead.Email, lead.Phone, funnelID, stageID)
	// if err != nil {
	// 	log.Warnw("Failed to create test lead in Holded CRM", "error", err)
	// } else {
	// 	log.Infow("Created test lead in Holded CRM", "leadID", leadID)
	// }
	// return
	// Generate BI report
