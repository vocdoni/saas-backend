...
func (m *mockMongoStorage) Organization(address internal.HexBytes) (org *db.Organization, err error) {
...
func (m *mockMongoStorage) OrganizationWithParent(address internal.HexBytes) (
